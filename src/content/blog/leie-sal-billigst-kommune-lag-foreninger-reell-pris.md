...
## Listepris mot reell pris: rabattordninger for lag og foreninger
...
## Slik søker foreningen om fritak eller redusert leie

Faller aktiviteten utenfor de faste rabattene, kan foreningen søke om friplass eller redusert leie. Dette er en enkeltvedtakssak: du oppgir formål, målgruppe og dato, og saksbehandleren avgjør etter kommunens retningslinjer. Typiske grunnlag er inntektssvakt arrangement, åpen aktivitet for lokalmiljøet eller ren dugnad.

Søknaden er verdt innsatsen når beløpet er stort nok. Skal foreningen leie en kultursal til en gratis julekonsert, kan et fritak være forskjellen på at arrangementet går rundt eller går i minus. For små treningstimer er den ordinære foreningsrabatten som regel nok.

I Digilist ligger søknad om fritak i samme flyt som selve bookingen. Du velger salen, ser hva ordinær foreningspris blir, og huker av for søknad om friplass før du sender. Saksbehandleren får søknaden med all kontekst, og laget slipper å lete opp riktig skjema eller e-postadresse.
...
## Fast ukedag hele sesongen mot enkeltbooking

For en forening med ukentlig aktivitet er sesongleie nesten alltid billigere enn å booke time for time. Mange kommuner gir egen sesongsats: booker laget tirsdager 18 til 20 fra september til april, får dere lavere timepris enn ved 30 løse bookinger, og dere sikrer samme tid hele sesongen.

Regnestykket er enkelt. 30 kvelder à to timer til 300 kroner er 18 000 kroner som enkeltbooking. Med en sesongsats på for eksempel 220 kroner timen faller kostnaden til 13 200 kroner. Det er 4 800 kroner spart, og i tillegg slipper dere risikoen for at tiden blir opptatt av noen andre midt i sesongen.

Fordelen er ikke bare pris. En fast tildeling gir forutsigbarhet for treningsplan, foreldre og trenere, mens løse bookinger må sikres på nytt hver uke. Digilist viser sesongpris og enkeltpris ved siden av hverandre, så dere ser både kroner spart og hva forutsigbarheten koster, før dere binder dere.

## Skjulte kostnader å sjekke før du booker

Timeprisen er ikke hele regningen. Før dere booker, sjekk:

- **Depositum:** for arrangementer krever mange kommuner 1 000 til 5 000 kroner i depositum ved leie av lokale, som betales tilbake etter godkjent tilbakelevering.
- **Rengjøring:** noen saler har obligatorisk rengjøringsgebyr, andre krever at dere vasker selv.
- **Strøm og utstyr:** lyd, lys og scene kan komme som tillegg.

Disse postene er lett å overse fordi de sjelden står i selve prisregulativet, men i et eget reglement eller et vedlegg til leiekontrakten. For et arrangement kan de til sammen utgjøre mer enn timeleien.

I Digilist ligger disse tilleggene på salens side, ikke gjemt i et vedlegg. Totalprisen du ser inkluderer depositum og gebyrer, slik at den reelle kostnaden er tydelig før bekreftelse.

## Betalingsvilkår og avbestillingsregler

Reell pris påvirkes også av vilkårene. Sjekk betalingsfrist, om depositumet holdes tilbake, og hvor sent dere kan avbestille uten å betale. En avbestilling to dager før kan i noen kommuner koste full leie, mens grensen ofte går ved sju dager. For en forening med stramt budsjett er dette forskjellen på null og full pris, og det er en kostnad dere aldri ser i prislisten.

Digilist viser avbestillingsfristen på bookingen og håndterer refusjon av depositum automatisk når vilkårene er oppfylt, så dere vet nøyaktig når det er trygt å endre planene.

## Slik booker foreningen billigste ledige lokale i Digilist

Laget søker på dato og kapasitet, ser foreningsprisen inkludert rabatt, depositum og eventuell sesongsats, sammenligner ledige saler på tvers av kommuner, og sender søknad om friplass i samme flyt om det trengs. Ingen leting i regulativet, ingen skjulte tillegg ved bekreftelse, og ingen tvil om hvilken kategori dere havner i.

Vil dere se hvordan foreningen finner og booker billigste ledige sal automatisk? **Book en demo**, så viser vi det med deres egne lokaler og satser.